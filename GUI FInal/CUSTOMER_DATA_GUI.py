'''````````````````````````````````````````````````````````````````````````````````````````````````````````````````````
    File: CUSTOMER_DATA_GUI.py - This code is used in the NATO PHOTOGRAPHY LOGIN GUI.py to store and view customer data
...
alt_Label=Label(root,text="Photo: Silhouette of a man in a fedora", font=("Calibri, 10"))
alt_Label.grid (row= 20,column= 0, columnspan= 6)
